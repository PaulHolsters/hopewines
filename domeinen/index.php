...
<input type='text' name='filter'><input type='submit' value='Ok' name='ok'></form>";
    ...
    echo "<form action='aanmaken.php' method='post'><input type='submit' value='maak domein' name='sent'></form></th>";
    echo "</tr>
<tr><th class='w-fit'>Volgnummer</th><th class='w-250'>Domein</th></tr>
</thead>";
    ...
    if($filter){
        ...
        if (isset($result->num_rows)) {
            if ($result->num_rows > 0) {
                ...
                echo "<tfoot><tr><td colspan='2'>Nog geen domeinen ingevoerd.</td></tr></tfoot>";
            }
        }
    }
    else{
